...
pull-worktree .config/nvim/bundle/elixir https://github.com/elixir-lang/vim-elixir.git
...
pull-worktree .config/nvim/bundle/pandoc https://github.com/vim-pandoc/vim-pandoc.git
pull-worktree .config/nvim/bundle/pandoc-syntax https://github.com/vim-pandoc/vim-pandoc-syntax.git
